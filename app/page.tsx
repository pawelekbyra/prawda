...
const Header = () => (
  <header className="bg-black text-white py-12 px-4 shadow-lg border-b-4 border-red-700 w-full">
...
const Footer = () => (
  <footer className="max-w-4xl mx-auto px-4 py-12 border-t border-slate-200 w-full">
...
export default function Page() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex flex-col min-h-screen bg-[#f8f9fa] font-sans text-slate-900 selection:bg-red-100 selection:text-red-900">
        <Header />
          ...
          <div className="w-full max-w-[420px] space-y-8">
            <div className="bg-white p-12 rounded-[2.5rem] shadow-lg border border-black border-t-4 border-b-4">
              <form className="space-y-10" onSubmit={handleLogin}>
                ...
                <button
                  type="submit"
                  className="w-full bg-black text-white py-4 text-[10px] font-bold uppercase tracking-[0.4em] hover:opacity-90 transition-all rounded-2xl"
                >
                  Enter
                </button>
                {error && (
